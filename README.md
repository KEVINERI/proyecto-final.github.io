...
<body>
    ...
    <section id="galeria">
       ...
       <p>Conoce The Legend Of Zelda Tears of the Kingdom como el ganador a la categoria "Mejor juego de Aventura".</p>
    ...
    <section id="contacto">
      ...
      <p> Redes Sociales:</p>
      <img src="https://www.pngkit.com/png/full/17-175351_social-icons-transparent-background-png-iconos-redes-sociales.png" />
       
    </section>

    <footer>
        <p>&copy; 2023 GameDesignArtHub</p>
    </footer>
